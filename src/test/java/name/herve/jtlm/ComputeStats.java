	...
	public static void main(String[] args) {
		try {
			...
			for (String u : storage.getStoredUsers()) {
				...
				System.out.println(u + ", " + ud.size() + ", " + alsoFollowing + ", " + hms((long) avgDist) + ", " + nbVeryClose1 + ", " + nbVeryClose2 + ", " + nbVeryClose5 + ", " + nbVeryClose10 + ", " + nbVeryClose15 + ", " + nbVeryClose20 + ", " + nbVeryClose25 + ", " + nbVeryClose30);
			}
